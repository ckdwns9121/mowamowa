...
6. **Implement tasks (loop until done or blocked)**
   ...
   - Mark task complete in the tasks file (using the path from contextFiles/instruction) according to the schema's tracking format (e.g., `- [ ]` → `- [x]` for Markdown checkboxes)
