...
구현 방식과 무관하게 Orbit이 항상 지켜야 하는 제품·데이터·보안 규칙을 관리한다.
...
- [데이터베이스 마이그레이션](database-migration-policy.md)

정책의 의미를 바꾸는 변경은 관련 ADR과 함께 검토한다. 새 정책은 [Policy template](../templates/policy-template.md)을 사용한다.
